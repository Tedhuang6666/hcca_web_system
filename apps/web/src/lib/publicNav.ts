...
export const PUBLIC_NAV_ITEMS: PublicNavItemDef[] = [
  ...
  { key: "regulations", href: "/public/regulations", label: "法規查詢", description: "現行條文、沿革與版本", icon: Scale, group: "data", guestUsable: true, moduleId: "regulations" },
  { key: "documents", href: "/public/documents", label: "公文查詢", description: "公開公文、字號與附件", icon: FileSearch, group: "data", guestUsable: true, moduleId: "documents" },
