...
const OPTIONS: { key: keyof NotificationPreferences; label: string; desc: string }[] = [
  ...
  { key: "meeting_invited", label: "會議邀請", desc: "被列入會議名冊或議程確認時提醒" },
  { key: "meeting_today", label: "今日會議", desc: "會議即將開始、報到與場控提醒" },
  { key: "meeting_minutes_ready", label: "會議紀錄", desc: "會議紀錄完成或轉成公文時提醒" },
  { key: "regulation_review_assigned", label: "法規審議", desc: "法規排入議程或需要審議時提醒" },
  { key: "regulation_publish_ready", label: "法規待公布", desc: "法規完成議會核定等待公布時提醒" },
  { key: "regulation_published", label: "法規公布", desc: "法規發布、修正或廢止時提醒" },
  { key: "petition_assigned", label: "陳情指派", desc: "陳情案件被分派給您或所屬機關時提醒" },
  { key: "petition_replied", label: "陳情回覆", desc: "陳情已有公開回覆或補件要求時提醒" },
  ...
  { key: "calendar_event_updated", label: "行事曆異動", desc: "行程時間、地點、參與者或準備事項變更" },
  { key: "work_item_assigned", label: "工作指派", desc: "社群平台或系統建立的工作被指派給您" },
