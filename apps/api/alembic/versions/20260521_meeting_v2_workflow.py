...
def upgrade() -> None:
    op.add_column("meal_orders", sa.Column("availability_id", uuid_col, nullable=True))
    op.add_column("meal_orders", sa.Column("pickup_slot_id", uuid_col, nullable=True))
    op.add_column("meal_orders", sa.Column("class_id", uuid_col, nullable=True))
    ...
    op.create_table(
        ...
        sa.Column("meeting_id", uuid_col, sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False),
        ...
        sa.Column("created_by", uuid_col, sa.ForeignKey("users.id", ondelete="RESTRICT"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("proposer_id", uuid_col, sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
        sa.Column("motion_type", sa.String(length=30), server_default="main", nullable=False),
        sa.Column("title", sa.String(length=200), nullable=False),
        sa.Column("content", sa.Text(), nullable=True),
        sa.Column("status", sa.String(length=30), server_default="pending", nullable=False),
        sa.Column("vote_id", uuid_col, sa.ForeignKey("meeting_votes.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("motion_id", uuid_col, sa.ForeignKey("meeting_motions.id", ondelete="SET NULL"), nullable=True),
        sa.Column("vote_id", uuid_col, sa.ForeignKey("meeting_votes.id", ondelete="SET NULL"), nullable=True),
        sa.Column("title", sa.String(length=200), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("meeting_id", uuid_col, sa.ForeignKey("meetings.id", ondelete="CASCADE"), primary_key=True),
        sa.Column(
            "agenda_item_id",
            uuid_col,
            sa.ForeignKey("meeting_agenda_items.id", ondelete="SET NULL"),
        ...
        sa.Column("updated_by", uuid_col, sa.ForeignKey("users.id", ondelete="SET NULL"), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint("fk_meal_orders_class_id", "meal_orders", type_="foreignkey")
    op.drop_constraint("fk_meal_orders_pickup_slot_id", "meal_orders", type_="foreignkey")
    op.drop_constraint("fk_meal_orders_availability_id", "meal_orders", type_="foreignkey")
    op.drop_index("ix_meal_orders_class_id", table_name="meal_orders")
    op.drop_index("ix_meal_orders_pickup_slot_id", table_name="meal_orders")
    op.drop_index("ix_meal_orders_availability_id", table_name="meal_orders")
    op.drop_column("meal_orders", "class_id")
    op.drop_column("meal_orders", "pickup_slot_id")
    op.drop_column("meal_orders", "availability_id")
