...
KNOWN_PUBLIC_ROUTES: set[tuple[str, str]] = {
    ...
    ("/analytics/client-metrics/batch", "POST"),
    ...
    ("/partner-map/directory", "GET"),
    ("/recommended-vendors", "GET"),
    ("/recommended-vendors/categories", "GET"),
    ("/recommended-vendors/menus/{menu_id}/file", "GET"),
    ("/recommended-vendors/{vendor_id}", "GET"),
    ("/recommended-vendors/__module_health__", "GET"),
    ("/email/__module_health__", "GET"),
    ("/finance/__module_health__", "GET"),
    ("/publications/__module_health__", "GET"),
    ("/tasks/__module_health__", "GET"),
