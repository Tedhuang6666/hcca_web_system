...
from api.core.security import add_to_blacklist, create_signed_token, redis_client, revoke_user
...
def create_support_impersonation_token(
    ...
    return create_signed_token(payload, timedelta(minutes=minutes)), expires_at
